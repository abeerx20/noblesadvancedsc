...
- استيراد جماعي لأولياء الأمور من ملف Excel مع معاينة الصفوف وربط الأبناء بأرقام هوياتهم.
...
لاستيراد أولياء الأمور جماعيًا، استخدمي صفحة **إدارة أولياء الأمور > استيراد أولياء الأمور**. يجب أن يحتوي الصف الأول في ملف Excel على الأعمدة التالية: `اسم ولي الأمر`، `رقم هوية ولي الأمر`، `البريد الإلكتروني`، `رقم الجوال`، `كلمة المرور`، `أرقام هويات الأبناء`. يمكن فصل أكثر من رقم هوية بفاصلة عربية أو إنجليزية. تعرض الصفحة معاينة المقبول والمرفوض قبل إنشاء الحسابات، وتقبل 500 ولي أمر كحد أقصى وملفًا بحجم 2 ميغابايت.

لاستيراد حسابات الموظفات جماعيًا، استخدمي صفحة **إدارة الموظفات والصلاحيات > استيراد حسابات الموظفات**. الأعمدة المطلوبة هي: `اسم الموظفة`، `رقم الهوية`، `البريد الإلكتروني`، `كلمة المرور`، `رقم الجوال`، `الرقم الوظيفي`، `الدور`. يمكن كتابة الدور بالعربية أو بالقيمة الإنجليزية مثل `teacher`. تتم المعاينة قبل الحفظ، وتُرفض الصفوف المكررة أو غير الصالحة دون إيقاف بقية الصفوف. لا تُعرض كلمات المرور في نتيجة المعاينة.
